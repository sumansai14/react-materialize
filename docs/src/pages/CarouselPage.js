...
const desc = `Our Carousel is a robust and versatile component that can be an
  image slider, to an item carousel, to an onboarding experience.
...
const CarouselPage = () => (
  <Row>
    <Col s={12}>
      ...
      <Section>
        <h4>Full Width Slider with Fixed Item</h4>
